...
void update_mouse_position(Game *game, SDL_Window *window)
{
    int mouse_x, mouse_y;
    ...
    if (fit_height) {
        ...
        motion_y = (int) ((float) mouse_y / height * SCREEN_HEIGHT);
        ...
        motion_x = (int) ((float) mouse_x / width * SCREEN_WIDTH);
...
int main(int argc, char *argv[])
{
    ...
    while (!game->quit) {
        ...
        //// HANDLE INPUT //////////////////////////////
        update_mouse_position(game, window);
